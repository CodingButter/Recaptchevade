...
const solveCaptcha = async function (page, options, submit) { // Set client options and default client options
    ...
    let response = await client.decodeRecaptchaV2({googlekey: siteKey, pageurl: page.url()})
